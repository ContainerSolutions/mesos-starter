package com.containersolutions.mesos.containers;
...
public class MesosSlaveTagged extends MesosAgent {
    public static final String MESOS_IMAGE_TAG = MesosMasterTagged.MESOS_IMAGE_TAG;
    ...
    public MesosSlaveTagged(ZooKeeper zooKeeperContainer, String resources) {
        super(DockerClientFactory.build(), zooKeeperContainer, agentConfig(resources, MesosAgentConfig.DEFAULT_MESOS_AGENT_PORT, MesosAgentConfig.MESOS_AGENT_IMAGE, MESOS_IMAGE_TAG));
        LOG.debug("Using image: " + MesosAgentConfig.MESOS_AGENT_IMAGE + ":" + MESOS_IMAGE_TAG);
    }
