...
public class MesosMasterTagged extends MesosMaster {
    ...
    public MesosMasterTagged(ZooKeeper zooKeeperContainer) {
        super(DockerClientFactory.build(), zooKeeperContainer, masterConfig(MesosMasterConfig.MESOS_MASTER_IMAGE, MESOS_IMAGE_TAG));
        LOG.debug("Using image: " + MesosMasterConfig.MESOS_MASTER_IMAGE + ":" + MESOS_IMAGE_TAG);
    }
